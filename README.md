# JBusAndroid-Frontend (Android Studio)

This program is the frontend for the JBus app. It is written in Java and uses Android Studio. For the backen, check JBus in my repositories or click [JBus Backend]( https://github.com/AjriyaArkan/JBus).
